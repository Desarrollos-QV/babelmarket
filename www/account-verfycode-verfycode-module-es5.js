(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-verfycode-verfycode-module"], {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    let VerfycodePage = class VerfycodePage {
      constructor(route, server, toastController, keyboard, nav, loadingController, events, firebaseAuthentication) {
        this.route = route;
        this.server = server;
