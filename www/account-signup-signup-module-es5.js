          ...
          this.server.signup(data).subscribe(response => {
            if (response.msg != "done") {
              ...
              if (this.login_view == true) {
                // Viene ya de la verificacion telefonica
