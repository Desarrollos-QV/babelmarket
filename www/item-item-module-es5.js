        ...
        this.route.queryParams.subscribe(params => {
          if (params.id) {
            ...
            this.server.getStore(params.id + "?lid=" + lid + "&lat=" + lat + "&lng=" + lng).subscribe(data => {
              if (data.data) {
                this.data = data.data[0]; // Order Sort_no
