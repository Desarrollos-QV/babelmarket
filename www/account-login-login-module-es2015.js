...
/* harmony import */ var _ionic_native_sms_retriever_ngx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic-native/sms-retriever/ngx */ "./node_modules/@ionic-native/sms-retriever/ngx/index.js");
...
/* harmony import */ var _ionic_native_firebase_authentication_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/firebase-authentication/ngx */ "./node_modules/@ionic-native/firebase-authentication/ngx/index.js");
                ...
                if (this.OTP == this.OTPorigin) {
                    ...
                    this.server.chkUser(allData).subscribe((res) => {
                        if (res.msg == 'phone_exist') {
                            ...
                            this.server.SignPhone({ phone: this.number_phone, user_id: res.user_id }).subscribe((req) => {
                                if (req.msg == 'done') {
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        ...
        _ionic_native_sms_retriever_ngx__WEBPACK_IMPORTED_MODULE_6__["SmsRetriever"],
